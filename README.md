...
*Если в Вашей компании требуется знание вышеперечисленного, просьба не тратить наше время (но я готов пойти на уступки, если честно)*

- **HTML** - самый лучший язык программирования!
- точка с запятой в конце выражения в **JS** - это святое!
