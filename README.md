<h1>Всем привет 👋 </h1>
<em>Блин, народ, камон - осталось меньше 500 просмотров до 5000! Давайте, поднажмите!</em>
<br />
<br />
<p>Я сижу ночами, учу веб-программирование, бесконечное количество библиотек и фреймворков только для того, чтобы зайдя на HH обнаружить, что моих знаний всё еще недостаточно. </p>

- Сейчас учу **TS** и **Redux**.
